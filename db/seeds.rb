...
# subscription_1 = Subscription.create!(title: 'Weekly', price: 10.00, status: "active", frequency: "weekly", customer_id: customer_1.id)
# subscription_2 = Subscription.create!(title: 'Monthly', price: 30.00, status: "active", frequency: "monthly", customer_id: customer_2.id)
# subscription_3 = Subscription.create!(title: 'Bi-Weekly', price: 20.00, status: "active", frequency: "bi-weekly", customer_id: customer_3.id)
# subscription_4 = Subscription.create!(title: 'Bi-monthly', price: 40.00, status: "active", frequency: "bi-monthly", customer_id: customer_4.id)
# subscription_5 = Subscription.create!(title: 'Monthly', price: 50.00, status: "canceled", frequency: "monthly", customer_id: customer_1.id)
